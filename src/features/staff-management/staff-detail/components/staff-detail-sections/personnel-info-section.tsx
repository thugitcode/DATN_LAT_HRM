    ...
    return (
        <div className="bg-white p-5 rounded-2xl border border-[#E4E4E7] shadow-sm">
            ...
            <div className="grid grid-cols-2 gap-4">
                <FormInput control={control} name="code" label={t('staffForm.fields.code.label')} placeholder={t('staffForm.fields.code.placeholder')} isRequired readOnly={!isCreate} variant={variant} />
