...
import { TimeAttendanceManagementTab } from '../time-attendance-management/components/time-attendance-management-tab';
      ...
      <div className="w-full">
        <Tabs
          ...
          classNames={{
            ...
            tabContent:
              'group-data-[selected=true]:text-[#006FEE] group-data-[selected=true]:font-semibold text-[#71717A]',
          }}
        >
