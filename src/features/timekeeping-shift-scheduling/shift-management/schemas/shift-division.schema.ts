...
export const shiftDivisinSchema = z.object({
  ...
  caId: z.string().min(1, 'Ca không được để trống'),
...
export type ShiftDivisinFormValues = z.infer<typeof shiftDivisinSchema>;
