        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          <div className="flex items-center gap-4">
            <div className="flex items-center gap-3">
              <Avatar
                src={currentStaff?.avatar || `https://ui-avatars.com/api/?name=${currentStaff?.name}&background=random`}
                className="w-12 h-12"
              />
              <div>
      ...
      <div className="space-y-4">
        {loadingList ? (
          ...
          <>
            ...
            {
              TAB_KEYS.SHIFT_EXPLANATION === activeKey && <ShiftExplanation staffId={currentStaff?.id} />
            }
            {
              TAB_KEYS.SHIFT_ASSIGNMENT === activeKey && <ShiftManagementContainer staffId={currentStaff?.id} />
            }
          </>
        )}
      </div>
