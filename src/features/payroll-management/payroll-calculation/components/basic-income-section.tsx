...
function SalaryRow({ label, sublabel, value, showFormula, formulaLabel, formatCurrency }: SalaryRowProps) {
    return (
...
export function BasicIncomeSection({ data }: BasicIncomeSectionProps) {
    ...
    return (
        <div className="bg-white rounded-xl border border-gray-200 overflow-hidden">
            <CardHeader icon={<IconCoinFilled />} title={t("payrollCalculation.detail.basicIncomeTitle")} value={data.contractTotalSalary} />
