      ...
      <div ref={ref}>
        ...
        >
          ...
          <PrintHeader
            ...
            unitName={unitName}
            title={t('print.title', { month: month + 1, year })}
            subtitle={
              departmentName ? `${t('print.department_label')}: ${departmentName}` : undefined
            }
          />
