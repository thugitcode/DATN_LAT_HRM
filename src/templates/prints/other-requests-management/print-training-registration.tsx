...
interface PrintTrainingRegistrationProps {
  data: GeneralRequest[];
  month?: string;
  companyName: string;
  unitName: string;
...
export const PrintTrainingRegistration = forwardRef<HTMLDivElement, PrintTrainingRegistrationProps>(
...
PrintTrainingRegistration.displayName = 'PrintTrainingRegistration';
