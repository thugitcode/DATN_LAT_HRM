      ...
      {menuSidebar?.map((menu) => (
        <li key={menu.id}>
          <Link
            to={menu.path}
            className={cn(
              'group flex items-center w-full rounded-[14px] overflow-hidden h-12 gap-2 py-3 text-[16px] leading-6 tracking-normal text-nowrap transition-colors group-[.active]:bg-primary text-[#8F99D3]',
